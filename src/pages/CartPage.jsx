        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
          ...
          <div className="grid lg:grid-cols-3 gap-8 sm:gap-10">
            ...
            <div className="bg-[#f3f1eb] border border-yellow-200 rounded-3xl p-6 sm:p-8 shadow-sm lg:sticky lg:top-24 h-fit">
              ...
              <button className="w-full bg-yellow-600 hover:bg-yellow-700 text-white font-semibold py-3 sm:py-4 rounded-full shadow-md transition text-sm sm:text-base">
                Proceed to Checkout
              </button>
            </div>
