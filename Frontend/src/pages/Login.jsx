...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.success) {
      // Get the newly stored user from context or localstorage to check role
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-yellow-600 hover:bg-yellow-700 text-white py-3 rounded-full font-semibold shadow-md transition disabled:opacity-50"
            >
